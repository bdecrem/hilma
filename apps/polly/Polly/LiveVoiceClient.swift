...
///   POSTs it to /api/polly/live/session, and applies the returned answer.
...
@MainActor
@Observable
final class LiveVoiceClient: NSObject, PollyVoiceClient {
    ...
    private var sessionResponse: PollyAPI.LiveSessionResponse?
    ...
    nonisolated func peerConnection(
        ...
        Task { @MainActor in
            ...
            case .connected:
                ...
                if !self.sessionStarted { self.status = "Waiting for Polly..." }
