...
struct MainTabsView: View {
    ...
    @State private var active: PollyTab = {
    ...
    var body: some View {
        ...
        .onChange(of: DeepLinkRouter.shared.topicChatSignal) {
            ...
            active = .topics
            Task {
                if let t = try? await PollyAPI.shared.listTopics().first(where: { $0.id == id }) {
        ...
        #endif
        // No forced color scheme — defer to PollyApp's @AppStorage preference
