...
struct DodoRadioDial: View {
    ...
    private var accessibilityText: String {
        ...
        case .listening: return holdToTalk ? "Ready. Press and hold to talk." : "Polly is listening"
        case .talking: return "Listening to you. Release to send."
        case .thinking: return "Polly is thinking"
        case .speaking: return "Polly is speaking"
