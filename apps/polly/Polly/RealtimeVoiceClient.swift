...
final class RealtimeVoiceClient: NSObject {
    ...
    private var sessionResponse: PollyAPI.RealtimeSessionResponse?
    ...
    func start() async {
        ...
        do {
            ...
            let session = try await PollyAPI.shared.startRealtimeSession(mode: mode, threadId: threadId, cardIds: cardIds,
    ...
    private func connectWebRTC(_ session: PollyAPI.RealtimeSessionResponse) async throws {
    ...
    private func runTool(callId: String, name: String, argumentsJSON: String) {
        ...
        Task {
            ...
            do {
                ...
                let data = try await PollyAPI.shared.callRealtimeTool(name: name, arguments: args)
    ...
    private func finishSession() async {
        ...
        try? await PollyAPI.shared.finishRealtimeSession(
            id: id,
