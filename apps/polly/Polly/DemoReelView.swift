                ...
                HStack {
                    ...
                    Button { onDone() } label: {
                        Image(systemName: "xmark")
                            ...
                            .background(PollyTheme.surface.opacity(0.6), in: Circle())
                    }
                    .buttonStyle(.plain)
                    .padding(.trailing, 14)
                }
        ...
        TimelineView(.animation(minimumInterval: 1.0 / 40.0)) { timeline in
            ...
            VStack(spacing: 0) {
                ...
                Canvas { ctx, size in
                    ...
                    g.stroke(ground, with: .color(PollyTheme.border), style: StrokeStyle(lineWidth: 2, lineCap: .round, dash: [0.1, 9]))
                }
                .frame(height: 330)
                Spacer()
        ...
        TimelineView(.animation(minimumInterval: 1.0 / 30.0)) { timeline in
            ...
            VStack(spacing: 14) {
                ...
                PeckWorldCanvas(height: 560, levelCount: (idx + 1) * 10,
                    ...
                    .overlay(RoundedRectangle(cornerRadius: 30).stroke(PollyTheme.border, lineWidth: 1))
                    .id("world-\(idx)")
                    .transition(.opacity)
                Spacer()
            }
