/*
 * Surf resources: the Settings dialog (DLOG/DITL 128, ported from Atkinson),
 * the one-field prompt dialog (DLOG/DITL 129, shared by Open Location and
 * Ask About Page - the label and button retitle at runtime), and SIZE.
 * Item numbers must match the k* defines in surf.c.
 */
...
/* ---- one-field prompt (Open Location / Ask About Page) ----
...
resource 'DITL' (129) {
    {
        /* 1 Go     */ { 92, 290, 112, 364 }, Button    { enabled, "Go" };
        /* 2 Cancel */ { 92, 200, 112, 274 }, Button    { enabled, "Cancel" };

        /* 3 label  */ { 12, 16, 28, 364 }, StaticText  { enabled, "Type a URL:" };
