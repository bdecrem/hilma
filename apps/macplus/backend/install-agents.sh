...
UID_N="$(id -u)"
ALL="code paint surf mux imessage diag quote bridge screen netspeed porthole pssh rsh pixel oracle"
DEFAULT_BOOT="surf mux imessage diag quote bridge screen netspeed porthole pssh rsh pixel oracle"
BOOT="${*:-$DEFAULT_BOOT}"
