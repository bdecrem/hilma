#!/usr/bin/env bash
# Build THE ORACLE for the Mac Plus with the Retro68 toolchain.
# Outputs Oracle.bin / Oracle.APPL / Oracle.dsk into ./build/.
set -euo pipefail
...
echo
echo "Built:"
ls -1 Oracle.bin Oracle.APPL Oracle.dsk 2>/dev/null
