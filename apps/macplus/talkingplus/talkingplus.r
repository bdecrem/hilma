/*
 * Talking Plus resources: the Settings dialog (DLOG/DITL 128, ported from Atkinson),
 * the Tell Him Something prompt dialog (DLOG/DITL 129), and SIZE.
 * Item numbers must match the k* defines in talkingplus.c.
 */
...
resource 'DITL' (129) {
    {
        /* 1 Go     */ { 92, 290, 112, 364 }, Button    { enabled, "Say It" };
        /* 2 Cancel */ { 92, 200, 112, 274 }, Button    { enabled, "Cancel" };

        /* 3 label  */ { 12, 16, 28, 364 }, StaticText  { enabled, "Tell him something:" };
