#!/usr/bin/env bash
# Build SerialDoc for the Mac Plus with the Retro68 toolchain.
# Outputs SerialDoc.bin / SerialDoc.APPL / SerialDoc.dsk into ./build/.
set -euo pipefail
...
echo
echo "Built:"
ls -1 SerialDoc.bin SerialDoc.APPL SerialDoc.dsk 2>/dev/null
