...
Taste signals: `StudioModel` derives turns from the feed (`turns`, `turnEnds` = finished turns keyed by
their last feed id), `castVote(-3…3, on:)` debounces to `JamAPI.vote`; `StudioView.voteRow` is the quiet
