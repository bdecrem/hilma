...
const KID=process.env.ASC_KEY_ID??"748UX45NAP", ISS="69a6de80-eb13-47e3-e053-5b8c7c11a4d1", APP="6773165027", VER=process.argv[2], PLAT=process.argv[3]??"IOS"; if(!VER){console.error("usage: node asc-submit.mjs <buildNumber> [IOS|MAC_OS]");process.exit(1)};
