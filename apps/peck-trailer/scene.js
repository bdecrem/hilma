...
(function () {
  ...
  const C = {
    ink: '#1e1a22', paper: '#f4ebd8', pink: '#ff3e9d', teal: '#00a3a0', mari: '#f2a52b',
    night: '#0e0c12', grey: '#b9b2a2', leaf: '#3f9a52', rat: '#cfc8bb',
  };
  ...
  function init() {
    ...
    PAT = {
      [C.teal]: bctx.createPattern(dotTile('#00605e', 12, 3.4), 'repeat'),
      [C.paper]: bctx.createPattern(dotTile('#a39a88', 12, 3.4), 'repeat'),
      [C.pink]: bctx.createPattern(dotTile('#b3176a', 12, 3.4), 'repeat'),
      [C.mari]: bctx.createPattern(dotTile('#a8630a', 12, 3.4), 'repeat'),
      [C.grey]: bctx.createPattern(dotTile('#6f695e', 12, 3.4), 'repeat'),
      [C.rat]: bctx.createPattern(dotTile('#6d665b', 12, 3.4), 'repeat'),
      [C.leaf]: bctx.createPattern(dotTile('#1e5a2c', 12, 3.4), 'repeat'),
  ...
  function drawDodo(ctx, x, y, s, o = {}) {
    ...
    if (glow > 0 && !spec) {
      ctx.save(); ctx.shadowColor = `rgba(0,163,160,${clamp(glow * 0.9)})`; ctx.shadowBlur = Math.min(170, 16 * s * glow);
    ...
    if (!spec) {
      ctx.save(); ctx.globalAlpha *= 0.6; ctx.fillStyle = C.pink; ctx.fill(DODO.cheekL); ctx.fill(DODO.cheekR); ctx.restore();
    }
  ...
  function drawEgg(ctx, x, y, s, o = {}) {
    ...
    if (glow) { ctx.save(); ctx.shadowColor = `rgba(244,235,216,${glow})`; ctx.shadowBlur = Math.min(150, 12 * s * glow); ctx.fillStyle = C.paper; ctx.fill(EGGP); ctx.restore(); }
  ...
  function drawRat(ctx, x, y, s, o = {}) {
    ...
    if (!sil) { ctx.strokeStyle = C.pink; ctx.lineWidth = 1.6; ctx.stroke(tail); }
    ...
    if (sil) {
      ...
      part(ctx, RAT.body, C.rat, 2, 5); part(ctx, RAT.head, C.rat, 2, 3); part(ctx, RAT.ear, C.pink, 1.6);
      if (ko) inkLine(ctx, [19, -14, 23, -10, 19, -10, 23, -14], 1.6);
      else { dot(ctx, 21, -12, 2.1); dot(ctx, 21.6, -12.6, 0.6, C.pink); inkLine(ctx, [17, -16.2, 24.5, -14], 1.8); }
      part(ctx, E2(31, -8, 2.3, 2.3), C.pink, 1);
  ...
  function drawPig(ctx, x, y, s, o = {}) {
    ...
    part(ctx, PIG.body, C.pink, 2.2, 6);
    inkLine(ctx, [-7, -8, -7 - sw, 0, 19, -8, 19 + sw, 0], 5);
    part(ctx, PIG.ear, C.pink, 1.6); part(ctx, PIG.head, C.pink, 2.2, 4); part(ctx, PIG.snout, '#ff8cc4', 1.8);
  ...
  function bellJar(ctx, cx, bottom, w, h, alpha = 0.55) {
    ctx.save(); ctx.strokeStyle = `rgba(244,235,216,${alpha})`; ctx.lineWidth = 6;
    ...
    ctx.lineWidth = 10; ctx.strokeStyle = `rgba(244,235,216,${alpha * 0.5})`;
  ...
  function thermo(ctx, cx, top, bottom, P, flash) {
    ...
    ctx.fillStyle = flash ? '#ff9ccb' : C.pink;
  ...
  function sea(ctx, t, sunY, sunR) {
    bg(ctx, C.night);
    glowAt(ctx, 540, sunY, sunR * 2.2, 'rgba(255,62,157,0.28)');
    ...
    ctx.fillStyle = 'rgba(255,62,157,0.35)';
    const r = rng(8);
    ...
    inkLine(ctx, [-100, sunY + sunR * 0.42, W + 100, sunY + sunR * 0.42], 3, 'rgba(244,235,216,0.5)');
  }
  ...
  function introEgg(ctx, t, lt, fx) {
    ...
    glowAt(ctx, 540, 1000, 700, 'rgba(244,235,216,0.18)');
    ctx.fillStyle = 'rgba(244,235,216,0.06)'; ctx.beginPath(); ctx.moveTo(420, -100); ctx.lineTo(660, -100); ctx.lineTo(900, 1250); ctx.lineTo(180, 1250); ctx.closePath(); ctx.fill();
    // nest
    const r = rng(44);
  ...
  function introEye(ctx, t, lt, fx) {
    bg(ctx, C.teal); field(ctx, 'ink', 0.4);
  ...
  function theyBrought(ctx, t, lt, fx) {
    ...
    radial(ctx, 540, 700, { n: 90, color: 'rgba(255,62,157,0.8)', seed: fr(t) >> 1, inner: 520, width: 0.01 });
  ...
  function pigs(ctx, t, lt, fx) {
    ...
    for (let i = 0; i < 6; i++) { const r = rng(i + 7); dot(ctx, 700 + r() * 300 + lt * 200, 1330 + r() * 40, 18 + r() * 30, 'rgba(30,26,34,0.25)'); }
  ...
  function oneDodo(ctx, t, lt, fx) {
    ...
    radial(ctx, 540, 900, { n: 120, color: C.teal, seed: fr(t) >> 1, inner: 520, width: 0.011 });
  ...
  const PECK_BG = [C.ink, C.paper, C.pink, C.teal, C.ink, C.paper];
  ...
  function peckMontage(ctx, t, lt, fx) {
    ...
    const u = t - PECKS[i], bgc = PECK_BG[i], dark = bgc === C.ink || bgc === C.teal;
  ...
  function meter(ctx, t, lt, fx) {
    ...
    if (flash) { ctx.fillStyle = 'rgba(255,62,157,0.18)'; ctx.fillRect(-300, -300, W + 600, H + 600); }
    radial(ctx, 700, 1250, { n: 90, color: 'rgba(244,235,216,0.5)', seed: fr(t) >> 1, inner: 480 - k * 120, width: 0.008 });
  ...
  function boat(ctx, t, lt, fx) {
    ...
    for (let i = 0; i < 5; i++) { const r = rng(i + 70); glowAt(ctx, 300 + r() * 500, 560 - lt * 300 - r() * 200, 160, 'rgba(244,235,216,0.2)'); }
  ...
  function museum(ctx, t, lt, fx) {
    ...
    ctx.fillStyle = `rgba(244,235,216,${0.07 * flick})`; ctx.beginPath(); ctx.moveTo(430, -100); ctx.lineTo(650, -100); ctx.lineTo(980, 1500); ctx.lineTo(100, 1500); ctx.closePath(); ctx.fill();
    glowAt(ctx, 540, 1150, 650, 'rgba(244,235,216,0.12)');
    drawDodo(ctx, 540, 1400, 6.6, { spec: true, shadow: true });
    plinth(ctx, 540, 1400, 4.4);
    bellJar(ctx, 540, 1400, 640, 830);
    ctx.restore();
    motes(ctx, t, 4, 50, 'rgba(244,235,216,0.35)');
  ...
  function history(ctx, t, lt, fx) {
    ...
    glowAt(ctx, 540, 1150, 900, 'rgba(244,235,216,0.14)');
    ...
    motes(ctx, t, 5, 40, 'rgba(244,235,216,0.3)');
  }
  function unless(ctx, t, lt, fx) {
    ...
    ctx.save(); ctx.translate(540, 1000); ctx.scale(z, z); ctx.translate(-540, -1000);
    glowAt(ctx, 540, 1000, 900, 'rgba(244,235,216,0.12)');
    ...
    if (live > 0) {
      ...
      bg(ctx, '#0b0a0e'); glowAt(ctx, 540, 1000, 900, 'rgba(0,163,160,0.25)');
  ...
  function shatter(ctx, t, lt, fx) {
    ...
    glowAt(ctx, 540, 1100, 800, 'rgba(0,163,160,0.3)');
    if (t > 24.26) radial(ctx, 540, 1000, { n: 110, color: 'rgba(0,163,160,0.8)', seed: fr(t) >> 1, inner: 520, width: 0.01 });
    ...
    if (t < 24.26) {
      ...
      ctx.strokeStyle = 'rgba(244,235,216,0.85)'; ctx.lineWidth = 4;
      ...
      ctx.fillStyle = 'rgba(210,235,240,0.55)'; ctx.strokeStyle = 'rgba(244,235,216,0.9)'; ctx.lineWidth = 3;
      for (let k = 0; k < 40; k++) {
  ...
  function finalOr(ctx, t, lt, fx) {
    bg(ctx, C.ink); field(ctx, 'paper', 0.1);
    radial(ctx, 540, 1150, { n: 100, color: C.teal, seed: fr(t) >> 1, inner: 520, width: 0.011 });
  ...
  function titleCard(ctx, t, lt, fx) {
    bg(ctx, C.ink); field(ctx, 'paper', 0.1);
    radial(ctx, 540, 1150, { n: 110, color: 'rgba(255,62,157,0.55)', seed: fr(t) >> 1, inner: 560, width: 0.009 });
    ...
    word(ctx, 'OR', 540, 450, { size: 130, font: ULTRA, fill: C.teal, slamAt: 27.52, t });
    ...
    if (t > 29.07) word(ctx, 'AT EVERY REST STOP IN DODO', 540, 1870, { font: MONO, size: 54, fill: 'rgba(244,235,216,0.8)', track: 6 });
  ...
  function post(t, fx) {
    ...
    o.fillStyle = 'rgba(244,235,216,0.16)';
