...
# The voice shots open real (short) live sessions.
set -e
...
# Infinity Chat
shot 10-infinity-chat-window 10 -StartTab topics -OpenTopic $INF
shot 11-infinity-study-sheet 11 -StartTab topics -OpenTopic $INF -OpenInfinitySessions 1
shot 12-infinity-vocab 13 -StartTab topics -OpenTopic $INF -OpenInfinitySessions 1 -OpenInfinityDrill vocab
shot 13-infinity-grammar 13 -StartTab topics -OpenTopic $INF -OpenInfinitySessions 1 -OpenInfinityDrill grammar
shot 14-infinity-quiz 20 -StartTab topics -OpenTopic $INF -OpenInfinitySessions 1 -OpenInfinityDrill quiz
shot 15-infinity-cleanup-walk 30 -StartTab topics -OpenTopic $INF -OpenInfinitySessions 1 -OpenInfinityDrill cleanup
shot 17-infinity-talk 16 -StartTab topics -OpenTopic $INF -OpenVoice 1
...
shot 22-path-lesson-talk 18 -StartTab topics -OpenTopic $LES -OpenVoice 1
# A guest lesson
