...
import { createArtifact, PEBBLES_BUCKET } from '@/lib/polly/artifacts'
...
// POST /api/polly/artifacts/image — save a photo pebble.
...
export async function POST(req: Request) {
  ...
  if (upErr) {
    console.error('[polly] pebble image upload failed:', upErr)
