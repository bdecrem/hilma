...
import { createArtifact, listArtifacts } from '@/lib/polly/artifacts'

export const runtime = 'nodejs'

// GET /api/polly/artifacts — every artifact the user has saved, newest first.
...
// POST /api/polly/artifacts — save { body, source?, thread_id? }.
