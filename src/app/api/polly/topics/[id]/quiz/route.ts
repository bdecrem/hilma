...
import { getThreadById, recordQuizStarted, type QuizKind } from '@/lib/polly/threads'
import { processMessage } from '@/lib/polly/agent'
import { isModelKey } from '@/lib/polly/llm'

export const runtime = 'nodejs'

// POST /api/polly/topics/[id]/quiz
// Body (optional): { kind: 'standard' | 'hard', model?: string }
// `model` is a registry key from lib/polly/llm.ts (the iOS/macOS picker) — the
