...
// GET /api/polly/topics/[id]/flash — the topic's deck + set history.
...
// POST /api/polly/topics/[id]/flash — generate {count} cards for the topic.
export async function POST(
  ...
  try {
    ...
    console.error('[polly/flash] generate failed:', e)
