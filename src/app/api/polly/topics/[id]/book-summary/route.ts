...
// GET /api/polly/topics/[id]/book-summary — the full summary (markdown and all).
...
// POST /api/polly/topics/[id]/book-summary — kick off generation. Returns 202
