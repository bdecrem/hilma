...
import { deleteFlashCard, updateFlashCard, type CardRating } from '@/lib/polly/flash'

export const runtime = 'nodejs'

// PATCH /api/polly/flash/cards/[cardId] — edit question / answer / distractors.
...
// DELETE /api/polly/flash/cards/[cardId]
