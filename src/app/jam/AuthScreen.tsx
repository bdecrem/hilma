      ...
      <div className="jl">
        ...
        <section className="jl-section">
          ...
          <ul className="jl-feat">
            ...
            <li><strong>Adapts to your taste</strong> — thumbs on any turn, stars on a track, and the corrections you make in chat feed a private taste note the agent reads on every turn. Fewer repeat corrections, and new tracks that start from the numbers your best ones settled on.</li>
