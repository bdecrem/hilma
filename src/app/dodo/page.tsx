  ...
  return (
    <main className="da">
      ...
      <article className="da-body">
        ...
        <div className="da-tour-slot da-video-slot">
          {/* The 50-second overview — regenerated by scripts/dodo-video. */}
          <video
            className="da-overview"
            src="/dodo/tour/overview.mp4"
            poster="/dodo/tour/overview-poster.jpg"
            controls
            playsInline
            preload="metadata"
          />
