...
export default function DodoTour() {
  ...
  return (
    <section className="dd-tour" aria-label="A tour of the app">
      <div className="dd-tour-inner">
        <div className="dd-tour-copy">
          <div className="dd-tour-eyebrow">
            The tour <span className="dd-tour-count">{i + 1} / {SLIDES.length}</span>
          </div>
          {/* All captions are stacked so the column keeps the height of the
