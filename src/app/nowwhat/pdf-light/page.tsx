    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ marginBottom: '20px', color: '#1a1a1a', fontWeight: 500, fontSize: '15px' }}>
          ...
          <p style={{ marginBottom: '20px' }}>
            Steve Jobs set out to build a bicycle for the mind. AGI can be a bicycle with wings, that lets us soar.
          </p>
          ...
          <p style={{ marginBottom: '20px', color: '#1a1a1a', fontWeight: 500 }}>
