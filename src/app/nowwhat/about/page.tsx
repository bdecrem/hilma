    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '11px', letterSpacing: '0.12em', color: '#555', textTransform: 'uppercase', marginTop: '32px', marginBottom: '12px' }}>The Question</div>

          <p style={{ marginBottom: '20px', color: '#fff', fontWeight: 600 }}>
            At CASBS I will explore what&rsquo;s on the other side of AGI: my own take on how to harness superintelligence to help people thrive and avoid the traps of cognitive <a href="https://pubmed.ncbi.nlm.nih.gov/27542527/" style={{ color: '#fff', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: '#555' }}>offloading</a>, <a href="https://arxiv.org/abs/2506.08872" style={{ color: '#fff', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: '#555' }}>debt</a> and <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6097646" style={{ color: '#fff', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: '#555' }}>surrender</a>.
          </p>

          <p style={{ marginBottom: '20px' }}>
            I&rsquo;m a tinkerer and a hopeless optimist, always curious about new tech and its potential to solve real problems. I spent five+ years in East Palo Alto building a national model for bridging the digital divide, then helped share those learnings nationally from the Steering Committee of the Community Technology Centers Network. I co-founded <a href="https://www.fullcirclefund.org" style={{ color: '#b0b0b0', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: '#444' }}>Full Circle Fund</a> and created the Mozilla Builders incubator, supporting activists and founders building a better internet. Along the way, I also played a key role in the Firefox 1.0 launch and led Disney&rsquo;s early App Store efforts after creating the first iPhone smash hit.
          </p>

          <p style={{ marginBottom: '20px' }}>
            For the last year, I&rsquo;ve been &ldquo;<a href="https://www.decremental.com" style={{ color: '#b0b0b0', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: '#444' }}>building with AI</a>,&rdquo; taking on increasingly ambitious projects, and I&rsquo;ve been blown away by the ability to &ldquo;manifest&rdquo; any software idea I can think of. But I&rsquo;ve also found myself paralyzed at times, overwhelmed by the lack of constraints and a feeling that when anything is possible, maybe nothing matters. I spent years discovering the magic of mashing knobs on analog synths, finding flow state after hours listening and modulating simple music sketches. Then I tried Suno, the AI music app, and it ruined music for me: in 30 seconds it could create any song for me, better than anything I could ever make, often capturing the exact mood I had in mind. I haven&rsquo;t touched the knobs since.
          </p>
          ...
          <div style={{ fontSize: '11px', letterSpacing: '0.12em', color: '#555', textTransform: 'uppercase', marginTop: '32px', marginBottom: '12px' }}>A Bicycle with Wings</div>
          ...
          <blockquote style={{
            ...
            <br /><span style={{ fontStyle: 'normal', color: '#444' }}>&mdash; Steve Jobs, 1990</span>
          </blockquote>
          ...
          <p style={{ marginBottom: '20px' }}>
            But it&rsquo;s not inevitable, or even the most likely outcome. We already can&rsquo;t put our phones down, and the feed algorithms and synthetic content are about to get a lot more addictive. Why work when we can &ldquo;vibe-work&rdquo;? (Microsoft is marketing that right now.) Why deal with our imperfect friends when we can have AI companions who are always there, always on our side? (<a href="https://www.commonsensemedia.org/press-releases/nearly-3-in-4-teens-have-used-ai-companions-new-national-survey-finds" style={{ color: '#b0b0b0', textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: '#444' }}>Three in four teens are already trying it</a>.) How do we resist cognitive surrender, or avoid becoming carbon-based DoorDash delivery drivers for the AI?
          </p>

          <p style={{ marginBottom: '20px', color: '#fff', fontWeight: 500 }}>
            If a bicycle with wings shows up at our doorstep, how do we learn to ride it and where do we point it?
          </p>

          <div style={{ fontSize: '11px', letterSpacing: '0.12em', color: '#555', textTransform: 'uppercase', marginTop: '32px', marginBottom: '12px' }}>The Project</div>
